...
struct sysent sysent[] = {
	...
	{ .sy_narg = AS(sigriscv_debug_info_args), .sy_call = (sy_call_t *)sys_sigriscv_debug_info, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 600 = sigriscv_debug_info */
};
